...
const lang: Partial<Lang> = {
  ...
  'List width': '列宽',
  'Expand lists to full width in list view': '在列表视图中将列表扩展到全宽',
  ...
  "When toggled, task data (from the Tasks plugin) will be displayed in the card's footer instead of the card's body.":
    '开启后，任务数据（来自 Tasks 插件）将显示在卡片页脚而非卡片主体中。',
  ...
  'Card body': '卡片主体',
  'Card footer': '卡片页脚',
  'Merge with linked page metadata': '合并链接页面元数据',
  ...
  'When toggled, the archived date/time will be added after the card title, e.g.- [ ] My card title 2021-05-14 10:00am. By default, it is inserted before the title.':
    '开启后，归档日期/时间将添加在卡片标题后，例如：[ ] 我的卡片标题 2021-05-14 10:00am。默认情况下，它插入在标题之前。',
  ...
  'Tag colors': '标签颜色',
  'Set colors for tags displayed in cards.': '设置卡片中显示的标签颜色。',
